...
export function Hero() {
  ...
  const getIconComponent = (iconName: string) => {
    switch (iconName) {
       case "scholar":
      return <GraduationCap className="h-5 w-5" />; // Example icon
    case "researchgate":
      return <FaResearchgate className="h-5 w-5" />; // Example icon
      case "github":
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          >
            <div className="space-y-2">
              ...
              >
                I’m a researcher, developer, and lecturer specializing in Machine Learning, Deep Learning, Computer Vision, and NLP, focused on solving real-world problems.
              </motion.p>
            </div>
            ...
            >
              ...
              <Button variant="outline" size="lg" asChild>
                <a 
                  href="/resume.pdf" 
                  download="Shuvashis_Sarker_Resume.pdf" 
                  target="_blank"                      
          ...
          >
            <div className="relative aspect-square w-full max-w-md overflow-hidden rounded-full">
              <Image
                ...
                priority
                sizes="(max-width: 1080px) 300vw, 600px"
              />
            </div>
          </motion.div>
        </div>
