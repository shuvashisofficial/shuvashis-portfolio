...
export function SkillsShowcase() {
  ...
  // ✅ Set initial state to "Machine Learning & Deep Learning"
  const [selectedCategory, setSelectedCategory] = useState<SkillCategory>("Machine Learning & Deep Learning");
  ...
  return (
    <section className="py-12 md:py-24">
      <div className="container px-4 md:px-6 mx-auto max-w-6xl text-center">
        ...
        >
          <Tabs
            defaultValue="Machine Learning & Deep Learning"
          ...
          >
            ...
            {categories.map((category) => (
              <TabsContent key={category} value={category} className="w-full">
                <div className="bg-muted/0 rounded-lg p-6">
